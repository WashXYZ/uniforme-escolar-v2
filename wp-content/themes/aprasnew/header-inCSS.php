@font-face {
    font-family: "ScriptEspecial";
    src: url("<?= get_template_directory_uri()?>/fonts/Gloss_And_Bloom.ttf") format("truetype");
...
Author: Washington de Sousa Meneses
Author URI: http://wsxdevstudio.com.br/
Version: 1.0
License: GNU General Public License
Text Domain: aprasdefault
*/
html,
body {
  height: 100%;
...
@font-face {
  ...
  font-weight: 400;
  font-display: block;
  src: url("<?= get_template_directory_uri()?>/fonts/fa-brands-400.woff2") format("woff2"), url("<?= get_template_directory_uri()?>/fonts/fa-brands-400.ttf") format("truetype"); }
...
@font-face {
  ...
  font-weight: 400;
  font-display: block;
  src: url("<?= get_template_directory_uri()?>/fonts/fa-regular-400.woff2") format("woff2"), url("<?= get_template_directory_uri()?>/fonts/fa-regular-400.ttf") format("truetype"); }
...
@font-face {
  ...
  font-weight: 900;
  font-display: block;
  src: url("<?= get_template_directory_uri()?>/fonts/fa-solid-900.woff2") format("woff2"), url("<?= get_template_directory_uri()?>/fonts/fa-solid-900.ttf") format("truetype"); }
...
@font-face {
  font-family: 'FontAwesome';
  font-display: block;
  src: url("<?= get_template_directory_uri()?>/fonts/fa-v4compatibility.woff2") format("woff2"), url("<?= get_template_directory_uri()?>/fonts/fa-v4compatibility.ttf") format("truetype");
